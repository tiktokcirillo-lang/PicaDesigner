...
export interface BrandReferenceCompatibilityReport {compatibilityScore: number; compatiblePatterns: string[]; adaptablePatterns: string[]; conflicts: BrandReferenceConflict[]; rejectedReferenceTraits: string[]; requiredBrandOverrides: string[]; adaptationPlan: BrandAdaptationAction[]; baselineBrandDriftRisk: number; baselineReferenceImitationRisk: number; /** @deprecated */ brandDriftRisk?: number; /** @deprecated */ referenceImitationRisk?: number}
export interface AdaptedDesignConstraints {composition?: DesignDNA['composition']; hierarchy?: DesignDNA['visualHierarchy']; color?: BrandColorSystem; typography?: BrandTypographySystem; spacing?: BrandSpacingCharacter; shape?: BrandShapeLanguage; photography?: BrandPhotographyStyle; materials?: string[]; iconography?: BrandIconography; brandDistinctiveAssets: DistinctiveBrandAsset[]; antiPatterns: string[]; adaptationActions: BrandAdaptationAction[]; confidence: number}
