...
export class AIAuthenticationError extends AIProviderError {
  override name = "AIAuthenticationError";
}
...
export class AIIdempotencyConflictError extends AIProviderError {
  override name = "AIIdempotencyConflictError";
}
export class UnsupportedAIInputError extends AIProviderError {
  override name = "UnsupportedAIInputError";
}
export class AnalysisPipelineError extends AIProviderError {
  override name = "AnalysisPipelineError";
}
